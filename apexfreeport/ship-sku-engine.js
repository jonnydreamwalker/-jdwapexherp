...
/** SKU ends with -64 = large 64 oz diet class */
...
async function quoteShipping(items, destZip) {
  ...
  // Free standard: $100+ AND 3+ items (64 oz lines OK if cart has 3+ total units)
  ...
  // Under 3 items (including a lone -64 diet): flat — no free shipping
